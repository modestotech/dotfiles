...
files="bash_aliases bash_logout bash_profile bashrc bin gitconfig gitignore_global inputrc tmux.conf vimfunctions vimmappings vimplugins vimrc vimsnippets vim" 
